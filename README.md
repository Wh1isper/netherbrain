...
[![codecov](https://codecov.io/gh/wh1isper/netherbrain/branch/main/graph/badge.svg)](https://codecov.io/gh/wh1isper/netherbrain)
...
Netherbrain is an general agent service created for my homelab, local first with IM integration.

- **Github repository**: <https://github.com/wh1isper/netherbrain/>
- **Documentation** <https://wh1isper.github.io/netherbrain/>
...
git remote add origin git@github.com:wh1isper/netherbrain.git
...
- Add the API Token to your projects secrets with the name `PYPI_TOKEN` by visiting [this page](https://github.com/wh1isper/netherbrain/settings/secrets/actions/new).
- Create a [new release](https://github.com/wh1isper/netherbrain/releases/new) on Github.
